...
function registerInput() {
    if (cardElements.get('colorpicker-input') != undefined) {
        return;
    }
    cardElements.define('colorpicker-input', colorPickerInput, {
        extends: 'input'
    });
}
...
function registerButton() {
    if (cardElements.get('colorpicker-button') != undefined) {
        return;
    }
    cardElements.define('colorpicker-button', colorPickerButton, {
        extends: 'button'
    });
}
